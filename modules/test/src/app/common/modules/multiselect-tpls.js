...
angular.module('am.multiselect', [])
    ...
    .directive('amMultiselect', amMultiselect)
    .directive('amMultiselectPopup', amMultiselectPopup)
...
function amMultiselect($parse, $document, $compile, $interpolate, $filter, optionParser) {
    return {
        restrict: 'E',
        require: 'ngModel',
...
function amMultiselectPopup($document, $filter) {
    return {
        restrict: 'E',
        scope: false,
        replace: true,
